...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/whitequark/parser/issues", "changelog_uri" => "https://github.com/whitequark/parser/blob/v2.7.0.3/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/parser/2.7.0.3", "source_code_uri" => "https://github.com/whitequark/parser/tree/v2.7.0.3" } if s.respond_to? :metadata=
