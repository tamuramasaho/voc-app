...
ActiveRecord::Schema.define(version: 2020_01_21_160949) do
  ...
  create_table "words", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
